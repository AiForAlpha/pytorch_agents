...
import pytorch_agents
from pytorch_agents.common.type_aliases import TensorDict
from pytorch_agents.common.utils import get_device
...
def save_to_zip_file(
    ...
    with zipfile.ZipFile(save_path, mode="w") as archive:
        ...
        archive.writestr("_pytorch_agents_version", pytorch_agents.__version__)
